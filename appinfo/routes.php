...
return [
    'routes' => [
        ...
        ['name' => 'time_entry#approveEmergency', 'url' => '/api/time-entries/{id}/approve-emergency', 'verb' => 'POST'],
        ...
        // Overtime Payout API
        ['name' => 'overtime_payout#index', 'url' => '/api/overtime-payouts/{year}', 'verb' => 'GET', 'requirements' => ['year' => '\d+']],
        ...
        ['name' => 'report#pdfRange', 'url' => '/api/reports/pdf-range', 'verb' => 'GET'],
