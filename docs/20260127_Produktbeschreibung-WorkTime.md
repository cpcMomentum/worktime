...
| **Überstundenkonto** | Individuell pro Mitarbeiter, zurücksetzbar durch Admin |
| **Urlaubsverwaltung** | Urlaubstage beantragen, halbe Tage möglich, Restanspruch sehen |
| **Feiertagsverwaltung** | Bundesland-spezifische Feiertage, halbe Feiertage möglich |
| **Abwesenheiten** | Krank, Sonderurlaub, Unbezahlter Urlaub erfassen |
| **Projekt-Feld** | Optional, Autocomplete + Freitext für Kundenzuordnung |
| **Ort-Feld** | Optional (Büro/Mobil), kein Tracking |
| **Monats-PDF** | Zeitnachweis mit allen Daten + Signaturfeld |
| **Team-Übersicht** | Vorgesetzte sehen Zeiten des Teams |
| **Admin-Bereich** | Stammdaten pflegen |
...
2. Kann bearbeiten:
   - Mitarbeiter: Soll-Arbeitszeit/Woche, Urlaubsanspruch/Jahr, Bundesland, Vorgesetzter (optional)
   - Feiertage: Bundesland auswählen, manuelle Feiertage hinzufügen, halbe Feiertage markieren
...
| overtime_balance | Integer | Aktuelles Überstundenkonto in Minuten |
...
| project | String | Projekt/Kunde (optional, Freitext) |
